...
class _TourDetailScreenState extends State<TourDetailScreen>
  ...
  // Sigiriya Rock Fortress coordinates
  static const _sigiriyaLatLng = LatLng(7.9572, 80.7600);
  ...
  Widget build(BuildContext context) {
    ...
    final tourLatLng = _getLatLng(tour.title);
          ...
          NestedScrollView(
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Stack(
                    fit: StackFit.expand,
                    children: [
                      _TourHeroImage(source: tour.imageUrl),
                      // gradient overlay
                      DecoratedBox(
            ...
            body: TabBarView(
              ...
              children: [
                ...
                _ItineraryTab(isSigiriya: isSigiriya),
                _ReviewTab(rating: tour.rating),
                _MapTab(center: tourLatLng, isSigiriya: isSigiriya),
              ],
            ),
          ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ..._inclusions(isSigiriya).map((item) => _InclusionItem(label: item)),
        ],
      ),
    );
  }
...
class _ItineraryTab extends StatelessWidget {
  const _ItineraryTab({required this.isSigiriya});
  final bool isSigiriya;

  @override
  Widget build(BuildContext context) {
    final days = isSigiriya ? _sigiriyaDays : _genericDays;
      ...
      itemBuilder: (context, di) {
        ...
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            // Timeline events
            ...(day['events'] as List<Map<String, dynamic>>)
                .map((e) => _TimelineEvent(event: e)),
                      ...
                      children: [
                        ...
                        if (event['duration'] != null) ...[
                          ...
                          _Tag(
                            ...
                            color: const Color(0xFFE8B800).withValues(alpha: 0.15),
...
class _ReviewTab extends StatelessWidget {
  const _ReviewTab({required this.rating});
  final double rating;
  ...
  static const _reviews = [
    {
      ...
      'rating': 5,
      'text':
          'Absolutely breathtaking! The sun rise climb was magical, and our guide Dharini was incredibly knowledgeable — explained every fresco and inscription in vivid detail. Worth every rupee!',
      'helpful': 11,
    },
    {
      'name': 'Kavya Clini',
...
class _MapTab extends StatelessWidget {
  const _MapTab({required this.center, required this.isSigiriya});
  final LatLng center;
  final bool isSigiriya;

  @override
  Widget build(BuildContext context) {
    final stops = isSigiriya ? _sigiriyaStops : _genericStops(center);
